...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_description_SOURCE_PREFIX /home/igv/trist_ws4/src/realsense-ros/realsense2_description)
  set(realsense2_description_DEVEL_PREFIX /home/igv/trist_ws4/devel)
  ...
  set(realsense2_description_INSTALL_PREFIX /home/igv/trist_ws4/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/igv/trist_ws4/src/realsense-ros/realsense2_description/${idir}'.  ${_report}")
    endif()
