...
if("TRUE" STREQUAL "TRUE")
  set(vectornav_SOURCE_PREFIX /home/igv/trist_ws4/src/vectornav)
  set(vectornav_DEVEL_PREFIX /home/igv/trist_ws4/devel)
  ...
  set(vectornav_INSTALL_PREFIX /home/igv/trist_ws4/install)
...
if(NOT "/home/igv/trist_ws4/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vectornav' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/igv/trist_ws4/src/vectornav/${idir}'.  ${_report}")
    endif()
