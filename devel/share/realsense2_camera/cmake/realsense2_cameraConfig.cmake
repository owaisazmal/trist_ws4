...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_camera_SOURCE_PREFIX /home/igv/trist_ws4/src/realsense-ros/realsense2_camera)
  set(realsense2_camera_DEVEL_PREFIX /home/igv/trist_ws4/devel)
  ...
  set(realsense2_camera_INSTALL_PREFIX /home/igv/trist_ws4/install)
...
if(NOT "/home/igv/trist_ws4/devel/include " STREQUAL " ")
  set(realsense2_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/igv/trist_ws4/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/igv/trist_ws4/src/realsense-ros/realsense2_camera/${idir}'.  ${_report}")
    endif()
